...
RSpec.describe "/rounds", type: :request do
  ...
  # RoundsController, or in your router and rack
  ...
  describe "GET /index" do
    it "renders a successful response" do
      ...
      get rounds_url, headers: valid_headers, as: :json
  ...
  describe "POST /create" do
    context "with valid parameters" do
      it "creates a new Round" do
        expect {
          post rounds_url,
               params: { round: valid_attributes }, headers: valid_headers, as: :json
    ...
    context "with invalid parameters" do
      it "does not create a new Round" do
        expect {
          post rounds_url,
               params: { round: invalid_attributes }, as: :json
        }.to change(Round, :count).by(0)
      end

      it "renders a JSON response with errors for the new round" do
        post rounds_url,
             params: { round: invalid_attributes }, headers: valid_headers, as: :json
    ...
    context "with valid parameters" do
      ...
      it "updates the requested round" do
        ...
        patch round_url(round),
              params: { round: new_attributes }, headers: valid_headers, as: :json
        round.reload
  ...
  describe "DELETE /destroy" do
    it "destroys the requested round" do
      round = Round.create! valid_attributes
      expect {
        delete round_url(round), headers: valid_headers, as: :json
      }.to change(Round, :count).by(-1)
    end
  end
end
